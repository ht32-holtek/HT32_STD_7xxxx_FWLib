...
int main(void)
{
  ...
  /* Set the DAC0 channel 0 holding value                                                                   */
  DAC_SetData(HT_DAC0, DAC_CH0, CH_CONV_DATA_ALL);
...
void DAC_Configuration(void)
{
  ...
  DAC_ModeConfig(HT_DAC0, SYNC_MODE);

  /* Configure DAC0 channel 0                                                                               */
