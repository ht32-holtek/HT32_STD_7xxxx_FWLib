...
void Flash_Test(void)
{
  ...
  */
  ...
  /* Quad Write and Read (for verify)                                                                       */
  QSPI_FLASH_BufferWrite(gWrite_Buffer, FLASH_TEST_ADDR, FLASH_TEST_SIZE);
  QSPI_FLASH_BufferQuadRead((u16*)gRead_Buffer, FLASH_TEST_ADDR, FLASH_TEST_SIZE/2);
  Flash_Verify();
