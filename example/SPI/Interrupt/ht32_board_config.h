...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define HTCFG_SPI_MASTER_SEL_GPIO_ID             (HT_GPIOE)
  #define HTCFG_SPI_MASTER_SEL_GPIO_CLOCK(CK)      (CK.Bit.PE)

  #define HTCFG_SPI_MASTER_CLOCK(CK)               (CK.Bit.SPI0)
  #define HTCFG_SPI_MASTER                         (HT_SPI0)
  #define HTCFG_SPI_MASTER_IRQn                    (SPI0_IRQn)
  #define HTCFG_SPI_MASTER_SEL_AFIO_PORT           (GPIO_PE)
  #define HTCFG_SPI_MASTER_SCK_AFIO_PORT           (GPIO_PE)
  #define HTCFG_SPI_MASTER_MOSI_AFIO_PORT          (GPIO_PE)
  #define HTCFG_SPI_MASTER_MISO_AFIO_PORT          (GPIO_PE)
  #define HTCFG_SPI_MASTER_SEL_AFIO_PIN            (AFIO_PIN_0)
  #define HTCFG_SPI_MASTER_SCK_AFIO_PIN            (AFIO_PIN_1)
  #define HTCFG_SPI_MASTER_MOSI_AFIO_PIN           (AFIO_PIN_2)
  #define HTCFG_SPI_MASTER_MISO_AFIO_PIN           (AFIO_PIN_3)
