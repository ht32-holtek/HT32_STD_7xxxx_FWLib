...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define HTCFG_SPIM_SEL_GPIOX                    E
  #define HTCFG_SPIM_SEL_GPION                    0
  #define HTCFG_SPIM_SCK_GPIOX                    E
  #define HTCFG_SPIM_SCK_GPION                    1
  #define HTCFG_SPIM_MOSI_GPIOX                   E
  #define HTCFG_SPIM_MOSI_GPION                   2
  #define HTCFG_SPIM_MISO_GPIOX                   E
  #define HTCFG_SPIM_MISO_GPION                   3
