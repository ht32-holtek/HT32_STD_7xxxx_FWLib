...
REM ============================================================================
gsar.exe -s"#define FLASH_OPT (0)" -r"#define FLASH_OPT (1)" EWARM\ht32_op.c -o
gsar.exe -s"#define FLASH_OPT (0)" -r"#define FLASH_OPT (1)" EWARMv8\ht32_op.c -o
gsar.exe -s"#define FLASH_OPT (0)" -r"#define FLASH_OPT (1)" GNU_ARM\ht32_op.c -o
gsar.exe -s"#define FLASH_OPT (0)" -r"#define FLASH_OPT (1)" HT32-IDE\GNU_ARM\ht32_op.c -o
gsar.exe -s"FLASH_OPT     EQU     0" -r"FLASH_OPT     EQU     1" MDK_ARMv5\ht32_op.s -o
gsar.exe -s"FLASH_OPT     EQU     0" -r"FLASH_OPT     EQU     1" MDK_ARMv537\ht32_op.s -o
gsar.exe -s"#define ECC_OPT   (0)" -r"#define ECC_OPT   (1)" EWARM\ht32_op.c -o
gsar.exe -s"#define ECC_OPT   (0)" -r"#define ECC_OPT   (1)" EWARMv8\ht32_op.c -o
gsar.exe -s"#define ECC_OPT   (0)" -r"#define ECC_OPT   (1)" GNU_ARM\ht32_op.c -o
gsar.exe -s"#define ECC_OPT   (0)" -r"#define ECC_OPT   (1)"  HT32-IDE\GNU_ARM\ht32_op.c -o
gsar.exe -s"ECC_OPT             EQU     0" -r"ECC_OPT             EQU     1" MDK_ARMv5\ht32_op.s -o
gsar.exe -s"ECC_OPT             EQU     0" -r"ECC_OPT             EQU     1" MDK_ARMv537\ht32_op.s -o
gsar.exe -s"#define RAMECC_INTERRUPT                       (0)" -r"#define RAMECC_INTERRUPT                       (2)" system_ht32f7xxxx_01.c -o
