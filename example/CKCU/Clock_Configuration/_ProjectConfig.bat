...
REM ============================================================================
gsar.exe -s"#define RAMECC_INTERRUPT                       (0)" -r"#define RAMECC_INTERRUPT                       (1)" system_ht32f7xxxx_01.c -o
gsar.exe -s"#define RAMECC_NMI_HANDLER_OVER_WRITE_BY_IT    (0)" -r"#define RAMECC_NMI_HANDLER_OVER_WRITE_BY_IT    (1)" system_ht32f7xxxx_01.c -o
