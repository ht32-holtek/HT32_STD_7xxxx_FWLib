...
gsar.exe -s"<postbuild></postbuild>" -r"<postbuild>\"$TOOLKIT_DIR$\bin\isymexport.exe\" --edit \"$PROJ_DIR$\..\steering_file_IAR.txt\" \"$TARGET_PATH$\" \"$PROJ_DIR$\calculate_symbol_EWARM.o\"</postbuild>" EWARM\*.ewp -o
gsar.exe -s"<postbuild></postbuild>" -r"<postbuild>\"$TOOLKIT_DIR$\bin\isymexport.exe\" --edit \"$PROJ_DIR$\..\steering_file_IAR.txt\" \"$TARGET_PATH$\" \"$PROJ_DIR$\calculate_symbol_EWARMv8.o\"</postbuild>" EWARMv8\*.ewp -o

gsar.exe -s"REM ADD_YOUR_CODE_HERE" -r"REM ADD_YOUR_CODE_HERE:x0aNMCODE:x0aFIND1:x0aFIND2:x0aFORLOOK1:x0aFORLOOK2:x0aFORLOOK3:x0aDEL1:x0aDEL2" GNU_ARM\afterbuild.bat -o
gsar.exe -s"NMCODE" -r"arm-none-eabi-nm.exe %%SRC_PATH%%\%%VAR_OUTPUT_NAME%%.elf > nm.txt" GNU_ARM\afterbuild.bat -o
gsar.exe -s"FIND1" -r"findstr /G:x3A../steering_file_GNU.txt nm.txt > symbol.list" GNU_ARM\afterbuild.bat -o
gsar.exe -s"FIND2" -r"find /v /c \"\" < symbol.list" GNU_ARM\afterbuild.bat -o
gsar.exe -s"FORLOOK1" -r"(for /f \"tokens=1,2,3 delims= \" %%%%a in (symbol.list) do (" GNU_ARM\afterbuild.bat -o
gsar.exe -s"FORLOOK2" -r"    echo %%%%c = 0x%%%%a;" GNU_ARM\afterbuild.bat -o
gsar.exe -s"FORLOOK3" -r")) > calculate_symbol_GNU.ld" GNU_ARM\afterbuild.bat -o
gsar.exe -s"DEL1" -r"del nm.txt" GNU_ARM\afterbuild.bat -o
gsar.exe -s"DEL2" -r"del symbol.list" GNU_ARM\afterbuild.bat -o

gsar.exe -s"REM ADD_YOUR_CODE_HERE" -r"REM ADD_YOUR_CODE_HERE:x0aNMCODE:x0aFIND1:x0aFIND2:x0aFORLOOK1:x0aFORLOOK2:x0aFORLOOK3:x0aDEL1:x0aDEL2" HT32-IDE\afterbuild.bat -o
gsar.exe -s"NMCODE" -r"arm-none-eabi-nm.exe %%SRC_PATH%%\%%VAR_OUTPUT_NAME%%.elf > nm.txt" HT32-IDE\afterbuild.bat -o
gsar.exe -s"FIND1" -r"findstr /G:x3A../../../steering_file_GNU.txt nm.txt > symbol.list" HT32-IDE\afterbuild.bat -o
gsar.exe -s"FIND2" -r"find /v /c \"\" < symbol.list" HT32-IDE\afterbuild.bat -o
gsar.exe -s"FORLOOK1" -r"(for /f \"tokens=1,2,3 delims= \" %%%%a in (symbol.list) do (" HT32-IDE\afterbuild.bat -o
gsar.exe -s"FORLOOK2" -r"    echo %%%%c = 0x%%%%a;" HT32-IDE\afterbuild.bat -o
gsar.exe -s"FORLOOK3" -r")) > calculate_symbol_HT32.ld" HT32-IDE\afterbuild.bat -o
...
gsar.exe -s"        <name>User</name>" -r"        <name>User</name>:x0a"TFILE":x0a            <name>$PROJ_DIR$\..\calculate.c</name>:x0a"TCONFIGURATION":x0a"NAMEHT32":x0a"TSETTINGS":x0a"NAMEICCARM":x0a"TDATA":x0a"TOPTION":x0a"CCNAME":x0a"STATE":x0a"OPTION":x0a"DATA":x0a"SETTINGS":x0a"CONFIGURATION":x0a"UFILE"" EWARMv8\*.ewp -o
...
for /D %%d in (HT32-IDE\Project_*) do (
  ...
  gsar.exe -s"NAME" -r"			<name>User/calculate.c</name>" %%d\*.project -o
  gsar.exe -s"TYPE" -r"			<type>1</type>" %%d\*.project -o
  gsar.exe -s"LOCATIONURI" -r"			<locationURI>PARENT-2-PROJECT_LOC/calculate.c</locationURI>" %%d\*.project -o
  ...
  gsar.exe -s"FILEINFO" -r"id=:x22ilg.gnuarmeclipse.managedbuild.cross.config.elf.debug.2102899455.1307405103:x22 name=:x22icode.c:x22 rcbsApplicability=:x22disable:x22 resourcePath=:x22User/calculate.c:x22 toolsToInvoke=:x22ilg.gnuarmeclipse.managedbuild.cross.tool.c.compiler.989711717.139317847:x22" %%d\.cproject -o
