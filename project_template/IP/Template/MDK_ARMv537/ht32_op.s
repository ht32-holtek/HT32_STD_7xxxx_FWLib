...
;// <e0>  ECC RAM Function Active
;//   <i> Please check the usermanual to see if this feature is available.
ECC_OPT             EQU     0
;// </e>
...
OPT_CK              EQU     (nOB_PP0 + nOB_PP1 + nOB_PP2 + nOB_PP3 + nOB_CP)
    ...
    IF ECC_OPT = 1
OB_SYSCFG           EQU     0x7FFFFFFF
    ELSE
OB_SYSCFG           EQU     0xFFFFFFFF
    ENDIF
