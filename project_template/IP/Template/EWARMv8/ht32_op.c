...
/* Please check the usermanual to see if this feature is available.                                         */
#define ECC_OPT   (0)             /*!< ECC RAM Function Active                                              */
...
#define OPT_RES   (0xFFFFFFFF)
...
#if (ECC_OPT == 1)
  #define OB_SYSCFG (0x7FFFFFFF)
#else
  #define OB_SYSCFG (0xFFFFFFFF)
#endif
  ...
  __root const unsigned long HT32Option[20] @ "HT32_OPTIONS" = {
    ~OB_PP0,                            // 0x1FF00000
    ~OB_PP1,                            // 0x1FF00004
    ~OB_PP2,                            // 0x1FF00008
    ~OB_PP3,                            // 0x1FF0000C
