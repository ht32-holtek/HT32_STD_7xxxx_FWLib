...
/* Settings ------------------------------------------------------------------------------------------------*/
#define FLASH_OPT_PARTIALLOCK   (0)    /*!< 0: Disable Flash Option Bytes setting                           */
                                       /*!< 1: Enable Option Bytes setting                                  */

#define OB_KEY0        (0x00000000)    /*!< Protection Key Value                                            */
#define OB_KEY1        (0x00000000)    /*!< Protection Key Value                                            */
#define OB_KEY2        (0x00000000)    /*!< Protection Key Value                                            */
#define OB_KEY3        (0x00000000)    /*!< Protection Key Value                                            */
...
#define KPCTL_KPINVALID_OPT     (0)    /*!< Invalid Key Protection When Key Value Match                     */
#define KPCTL_MAXMISMATCH_OPT   (0)    /*!< Maximum Error Key Mismatch Trigger Option                       */
                                       /*!< 0: Return Mismatch                                              */
                                       /*!< 1: Hold MCU                                                     */
                                       /*!< 2: Mass Erase                                                   */

/* !!! Note: One OB_KPPP bit for setting n Pages. Check FMC chapter of User Manual for detailed.            */
#define OB_KPPP0       (0x00000000)    /*!< Main Flash Key Page Erase/Program Protection                    */
...
#define D_OB_KEY0      (0x00000000)    /*!< Double Check Protection Key Value                               */
#define D_OB_KEY1      (0x00000000)    /*!< Double Check Protection Key Value                               */
#define D_OB_KEY2      (0x00000000)    /*!< Double Check Protection Key Value                               */
#define D_OB_KEY3      (0x00000000)    /*!< Double Check Protection Key Value                               */

/* Flash ROM Region 0 Protection                                                                            */
#define FLASH_MPREG0CR_OPT      (0)    /*!< 0: Disable Region 0 Flash Option Bytes setting                  */
...
#define MPREG0_STARTPAGE_OPT    (8)    /*!< Start Page Range: 8 ~ 1022                                      */
#define MPREG0_ENDPAGE_OPT      (8)    /*!< End Page Range: 8 ~ 1022                                        */

/* Flash ROM Region 1 Protection                                                                            */
#define FLASH_MPREG1CR_OPT      (0)    /*!< 1: Enable Region 0 Option Bytes setting,
                                            0: Disable Region 0 Flash Option Bytes setting                  */
#define MPREG1CR_ACCESSTYPE_OPT (0)    /*!< 0: Protection, 1: Debug                                         */
#define MPREG1CR_MODE_OPT       (0)    /*!< 0: ICODE, 1: DCODE, 2: Access by Key                            */
#define MPREG1_STARTPAGE_OPT    (8)    /*!< Start Page Range: 8 ~ 1022                                      */
#define MPREG1_ENDPAGE_OPT      (8)    /*!< End Page Range: 8 ~ 1022                                        */
...
#if (FLASH_OPT_PARTIALLOCK == 1)
  __root const unsigned long HT32Option[20] @ "HT32_OPTIONS_PARTIALLOCK" = {
    OB_KEY0,                            // 0x1FF00080
    OB_KEY1,                            // 0x1FF00084
    OB_KEY2,                            // 0x1FF00088
    OB_KEY3,                            // 0x1FF0008C
