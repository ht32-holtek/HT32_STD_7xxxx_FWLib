...
#/*---------------------------------------------------------------------------------------------------------*/
CHIP_NAME = 72388
STARTUP = startup_ht32f7xxxx_gcc_01
TARGET_NAME = HT32
...
C_OPTION += -DUSE_HT32F72388_SK
C_OPTION += -DUSE_HT32F72368_78_88
C_OPTION += -DUSE_MEM_HT32F72388
S_OPTION = --defsym USE_HT32_CHIP=38
...
INCLUDE_PATH += -I./../../../../library/Device/Holtek/HT32F7xxxx/Include
INCLUDE_PATH += -I./../../../../library/HT32F7xxxx_Driver/inc
...
SOURCE_NAME_PATH += ../ht32f7xxxx_01_it.c
SOURCE_NAME_PATH += ../system_ht32f7xxxx_01.c
...
HT32_LIB_PATH = ../../../../library/HT32F7xxxx_Driver/src/
HT32_UTL_PATH = ../../../../utilities/

SOURCE_NAME_PATH += \
$(HT32_USB_PATH)ht32_usbd_core.c \
$(HT32_LIB_PATH)ht32_cm0plus_misc.c \
$(HT32_LIB_PATH)ht32f7xxxx_adc.c \
$(HT32_LIB_PATH)ht32f7xxxx_aes.c \
$(HT32_LIB_PATH)ht32f7xxxx_bftm.c \
$(HT32_LIB_PATH)ht32f7xxxx_can.c \
$(HT32_LIB_PATH)ht32f7xxxx_ckcu.c \
$(HT32_LIB_PATH)ht32f7xxxx_cmp.c \
$(HT32_LIB_PATH)ht32f7xxxx_crc.c \
$(HT32_LIB_PATH)ht32f7xxxx_dac.c \
$(HT32_LIB_PATH)ht32f7xxxx_div.c \
$(HT32_LIB_PATH)ht32f7xxxx_ebi.c \
$(HT32_LIB_PATH)ht32f7xxxx_exti.c \
$(HT32_LIB_PATH)ht32f7xxxx_flash.c \
$(HT32_LIB_PATH)ht32f7xxxx_gpio.c \
$(HT32_LIB_PATH)ht32f7xxxx_i2c.c \
$(HT32_LIB_PATH)ht32f7xxxx_i2s.c \
$(HT32_LIB_PATH)ht32f7xxxx_mctm.c \
$(HT32_LIB_PATH)ht32f7xxxx_pdma.c \
$(HT32_LIB_PATH)ht32f7xxxx_pwrcu.c \
$(HT32_LIB_PATH)ht32f7xxxx_ramecc.c \
$(HT32_LIB_PATH)ht32f7xxxx_rstcu.c \
$(HT32_LIB_PATH)ht32f7xxxx_rtc.c \
$(HT32_LIB_PATH)ht32f7xxxx_sci.c \
$(HT32_LIB_PATH)ht32f7xxxx_spi.c \
$(HT32_LIB_PATH)ht32f7xxxx_tm.c \
$(HT32_LIB_PATH)ht32f7xxxx_rng.c \
$(HT32_LIB_PATH)ht32f7xxxx_usart.c \
$(HT32_LIB_PATH)ht32f7xxxx_usbd.c \
$(HT32_LIB_PATH)ht32f7xxxx_wdt.c \
