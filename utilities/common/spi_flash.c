...
u32 SPI_FLASH_Init(void)
{
  ...
  */
  ...
  HT32_DVB_GPxConfig(FLASH_SPI_SIO2_GPIO_ID, FLASH_SPI_SIO2_AFIO_PIN, FLASH_SPI_SIO2_AFIO_MODE);
  HT32_DVB_GPxConfig(FLASH_SPI_SIO3_GPIO_ID, FLASH_SPI_SIO3_AFIO_PIN, FLASH_SPI_SIO3_AFIO_MODE);
  #endif
