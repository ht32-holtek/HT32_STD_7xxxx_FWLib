...
;/*                                                                                                         */
;/*-----------------------------------------------------------------------------------------------------------
;  File Name        : startup_ht32f7xxxx_01.s
;  Version          : $Rev:: 476          $
...
;//      <38=> HT32F72368/78/88
USE_HT32_CHIP_SET   EQU     38 ; Notice that the project's Asm Define has the higher priority.

_HT32FWID           EQU     0xFFFFFFFF
;_HT32FWID           EQU     0x00072368
;_HT32FWID           EQU     0x00072378
;_HT32FWID           EQU     0x00072388

HT32F72368_78_88    EQU     38
...
USE_LIBCFG_RAM_SIZE EQU     0x14000
  ENDIF

;//   <o> Stack Size (in Bytes, must 8 byte aligned) <0-81920:8>
...
;//   <o>  Heap Size (in Bytes) <0-81920:8>
Heap_Size           EQU     0
...
__Vectors           DCD  __initial_sp                       ; ---, 00, 0x000, Top address of Stack
                    ...
                    DCD  CMP0_1_DAC_IRQHandler              ;  07, 23, 0x05C,
                    DCD  ADC_IRQHandler                     ;  08, 24, 0x060,
                    DCD  AES_RNG_I2C2_IRQHandler            ;  09, 25, 0x064,
                    DCD  MCTM_IRQHandler                    ;  10, 26, 0x068,
                    DCD  QSPI_IRQHandler                    ;  11, 27, 0x06C,
                    DCD  GPTM_IRQHandler                    ;  12, 28, 0x070,
                    ...
                    DCD  SCI0_1_CAN0_IRQHandler             ;  27, 43, 0x0AC,
                    DCD  I2S_CAN1_IRQHandler                ;  28, 44, 0x0B0,
...
Default_Handler     PROC
                    ...
                    EXPORT  CMP0_1_DAC_IRQHandler           [WEAK]
                    EXPORT  ADC_IRQHandler                  [WEAK]
                    EXPORT  AES_RNG_I2C2_IRQHandler         [WEAK]
                    EXPORT  MCTM_IRQHandler                 [WEAK]
                    EXPORT  QSPI_IRQHandler                 [WEAK]
                    EXPORT  GPTM_IRQHandler                 [WEAK]
                    ...
                    EXPORT  SCI0_1_CAN0_IRQHandler          [WEAK]
                    EXPORT  I2S_CAN1_IRQHandler             [WEAK]
...
EXTI2_3_IRQHandler
EXTI4_15_IRQHandler
CMP0_1_DAC_IRQHandler
ADC_IRQHandler
AES_RNG_I2C2_IRQHandler
MCTM_IRQHandler
QSPI_IRQHandler
GPTM_IRQHandler
SCTM0_IRQHandler
