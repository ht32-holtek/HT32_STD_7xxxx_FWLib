...
#ifndef __HT32F7XXXX_PDMA_H
#define __HT32F7XXXX_PDMA_H
...
#endif
#if (LIBCFG_UART2)
#define PDMA_UART2_RX             PDMA_CH0                      /*!< UART1_RX PDMA channel number           */
#define PDMA_UART2_TX             PDMA_CH1                      /*!< UART1_TX PDMA channel number           */
#endif
#if (LIBCFG_UART3)
...
#define PDMA_SCI0_TX              PDMA_CH5                      /*!< SCI0_RX PDMA channel number            */
#endif
#if (LIBCFG_SCI1)
