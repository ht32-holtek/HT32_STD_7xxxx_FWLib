...
#ifndef __HT32F7XXXX_CKCU_H
#define __HT32F7XXXX_CKCU_H
...
typedef enum
{
  ...
  #endif
  #if (LIBCFG_CAN1)
  CKCU_PCLK_CAN1     = (CKCU_APBPCSR2 | 22),
  #endif
  #if (LIBCFG_RNG)
  CKCU_PCLK_RNG      = (CKCU_APBPCSR2 | 30),
  #endif
...
/* 4 MHz */
#define CKCU_PLL_4M_72M         ((0UL << 28) | (18UL << 23) | (0UL << 21))
#define CKCU_PLL_4M_64M         ((0UL << 28) | ( 0UL << 23) | (0UL << 21))
#define CKCU_PLL_4M_60M         ((0UL << 28) | (15UL << 23) | (0UL << 21))
#define CKCU_PLL_4M_48M         ((0UL << 28) | (12UL << 23) | (0UL << 21))
#define CKCU_PLL_4M_24M         ((0UL << 28) | ( 6UL << 23) | (0UL << 21))
/* 8 MHz */
#define CKCU_PLL_8M_72M         ((1UL << 28) | (18UL << 23) | (0UL << 21))
#define CKCU_PLL_8M_64M         ((1UL << 28) | (16UL << 23) | (0UL << 21))
#define CKCU_PLL_8M_60M         ((1UL << 28) | (15UL << 23) | (0UL << 21))
#define CKCU_PLL_8M_48M         ((0UL << 28) | ( 6UL << 23) | (0UL << 21))
#define CKCU_PLL_8M_40M         ((0UL << 28) | ( 5UL << 23) | (0UL << 21))
#define CKCU_PLL_8M_32M         ((0UL << 28) | ( 4UL << 23) | (0UL << 21))
#define CKCU_PLL_8M_24M         ((0UL << 28) | ( 3UL << 23) | (0UL << 21))
/* 12 MHz */
#define CKCU_PLL_12M_72M        ((0UL << 28) | ( 6UL << 23) | (0UL << 21))
#define CKCU_PLL_12M_60M        ((0UL << 28) | ( 5UL << 23) | (0UL << 21))
#define CKCU_PLL_12M_48M        ((0UL << 28) | ( 4UL << 23) | (0UL << 21))
#define CKCU_PLL_12M_24M        ((0UL << 28) | ( 2UL << 23) | (0UL << 21))
/* 16 MHz */
#define CKCU_PLL_16M_72M        ((1UL << 28) | ( 9UL << 23) | (0UL << 21))
#define CKCU_PLL_16M_64M        ((1UL << 28) | ( 8UL << 23) | (0UL << 21))
#define CKCU_PLL_16M_56M        ((1UL << 28) | ( 7UL << 23) | (0UL << 21))
#define CKCU_PLL_16M_48M        ((0UL << 28) | ( 3UL << 23) | (0UL << 21))
#define CKCU_PLL_16M_32M        ((0UL << 28) | ( 2UL << 23) | (0UL << 21))
...
#define IS_CKCU_DBG(MODE)       (((MODE & (~0xFCEFFFDF)) == 0) && (MODE != 0))
