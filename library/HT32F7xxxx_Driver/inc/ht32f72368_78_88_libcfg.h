...
#ifndef __HT32F72368_78_88_LIBCFG_H
#define __HT32F72368_78_88_LIBCFG_H

/* Settings ------------------------------------------------------------------------------------------------*/

#if !defined(USE_MEM_HT32F72368) && !defined(USE_MEM_HT32F72378) && !defined(USE_MEM_HT32F72388)
#define USE_MEM_HT32F72388
#endif
...
#ifdef USE_MEM_HT32F72368
  #define LIBCFG_FLASH_SIZE               (LIBCFG_FLASH_PAGESIZE * 512)
  #define LIBCFG_RAM_SIZE                 (1024 * 32)
  #define LIBCFG_CHIPNAME                 (0x72368)
#endif

#ifdef USE_MEM_HT32F72378
  #define LIBCFG_FLASH_SIZE               (LIBCFG_FLASH_PAGESIZE * 768)
  #define LIBCFG_RAM_SIZE                 (1024 * 64)
  #define LIBCFG_CHIPNAME                 (0x72378)
#endif

#ifdef USE_MEM_HT32F72388
  #define LIBCFG_FLASH_SIZE               (LIBCFG_FLASH_PAGESIZE * 1023)
  #define LIBCFG_RAM_SIZE                 (1024 * 64)
  #define LIBCFG_CHIPNAME                 (0x72388)
#endif
