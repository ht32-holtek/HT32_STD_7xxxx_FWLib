...
#define Set_FPSWOFF       SetBit_BB((u32)&HT_PWRCU->CR, 6)
#define Reset_FPSWOFF     ResetBit_BB((u32)&HT_PWRCU->CR, 6)
...
#define CR_ULDO_LEVEL_Msk ~(3 << CR_ULDO_LEVEL_Pos)
 ...
 *   - 0x0102 (PWRCU_FLAG_PD | PWRCU_FLAG_WUP0) : Both PDF and WUPF flags have been set.
 ************************************************************************************************************/
